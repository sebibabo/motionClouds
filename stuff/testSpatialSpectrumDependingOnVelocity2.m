...
temp  = histeq(rectifiedCloud1(:));
rectifiedCloud1 = reshape( temp, size(rectifiedCloud1,1),size(rectifiedCloud1,2),size(rectifiedCloud1,3));
...
temp  = histeq(rectifiedCloud2(:));
rectifiedCloud2 = reshape( temp, size(rectifiedCloud1,1),size(rectifiedCloud1,2),size(rectifiedCloud1,3));
...
temp  = histeq(rectifiedCloud3(:));
rectifiedCloud3 = reshape( temp, size(rectifiedCloud1,1),size(rectifiedCloud1,2),size(rectifiedCloud1,3));
...
temp  = histeq(rectifiedCloud4(:));
rectifiedCloud4 = reshape( temp, size(rectifiedCloud1,1),size(rectifiedCloud1,2),size(rectifiedCloud1,3));
...
temp  = histeq(rectifiedRectCloud1(:));
rectifiedRectCloud1 = reshape( temp, size(rectifiedCloud1,1),size(rectifiedCloud1,2),size(rectifiedCloud1,3));



rectCloud2 = random_cloud(rectZ2,1,0,0) ;
rectifiedRectCloud2 = rectif(rectCloud2, 1,'Michelson',1) ;
temp  = histeq(rectifiedRectCloud2(:));
rectifiedRectCloud2 = reshape( temp, size(rectifiedCloud1,1),size(rectifiedCloud1,2),size(rectifiedCloud1,3));


rectCloud3 = random_cloud(rectZ3,1,0,0) ;
rectifiedRectCloud3 = rectif(rectCloud3, 1,'Michelson',1) ;
temp  = histeq(rectifiedRectCloud3(:));
rectifiedRectCloud3 = reshape( temp, size(rectifiedCloud1,1),size(rectifiedCloud1,2),size(rectifiedCloud1,3));


rectCloud4 = random_cloud(rectZ4,1,0,0) ;
rectifiedRectCloud4 = rectif(rectCloud4, 1,'Michelson',1) ;
temp  = histeq(rectifiedRectCloud4(:));
rectifiedRectCloud4 = reshape( temp, size(rectifiedCloud1,1),size(rectifiedCloud1,2),size(rectifiedCloud1,3));
...
title(['frame with speed ',num2str(v1)])

subplot(2,7,3)
imshow(rectifiedCloud2(:,:,2))
title(['frame with speed ',num2str(v2)])

subplot(2,7,4)
imshow(rectifiedCloud3(:,:,3))
title(['frame with speed ',num2str(v3)])
subplot(2,7,5)
imshow(rectifiedCloud4(:,:,4))
title(['frame with speed ',num2str(v4)])
